...
//恢复对象
func (model *SqliteModel) Recover(item Map) (error) {
...
//批量删除
func (model *SqliteModel) Delete(args ...Any) (int64,error) {
...
//批量更新
func (model *SqliteModel) Update(sets Map, args ...Any) (int64,error) {
