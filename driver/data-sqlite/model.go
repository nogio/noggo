...
//创建对象
func (model *SqliteModel) Create(data Map) (Map,error) {
...
//修改对象
func (model *SqliteModel) Change(item Map, data Map) (Map,error) {
...
//删除对象
func (model *SqliteModel) Remove(item Map) (error) {
...
//查询唯一对象
func (model *SqliteModel) Entity(id Any) (Map,error) {
...
//批量删除
func (model *SqliteModel) Delete(args ...Map) (int64,error) {
...
//统计数量
func (model *SqliteModel) Count(args ...Map) (int64,error) {
...
//查询单条
func (model *SqliteModel) Single(args ...Map) (Map,error) {
...
//查询列表
func (model *SqliteModel) Query(args ...Map) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := model.base.building(args...)
	if err != nil {
		return nil,err
...
//分页查询
func (model *SqliteModel) Limit(offset,limit Any, args ...Map) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := model.base.building(args...)
	if err != nil {
		return nil,err
...
//查询列表
func (model *SqliteModel) Group(field string, args ...Map) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := model.base.building(args...)
	if err != nil {
		return nil,err
