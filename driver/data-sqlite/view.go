...
//统计数量
func (view *SqliteView) Count(args ...Map) (int64,error) {
...
//查询单条
func (view *SqliteView) Single(args ...Map) (Map,error) {
...
//查询列表
func (view *SqliteView) Query(args ...Map) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.building(args...)
	if err != nil {
		return nil,err
...
//分页查询
func (view *SqliteView) Limit(offset,limit Any, args ...Map) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.building(args...)
	if err != nil {
		return nil,err
...
//查询列表
func (view *SqliteView) Group(field string, args ...Map) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.building(args...)
	if err != nil {
		return nil,err
