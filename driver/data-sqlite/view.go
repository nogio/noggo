...
//统计数量
func (view *SqliteView) Count(args ...Any) (int64,error) {
...
//查询单条
func (view *SqliteView) Single(args ...Any) (Map,error) {
...
//查询列表
func (view *SqliteView) Query(args ...Any)  ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.parsing(args...)
	if err != nil {
		return []Map{},err
...
//分页查询
func (view *SqliteView) Limit(offset,limit Any, args ...Any) (int64,[]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.parsing(args...)
	if err != nil {
...
//查询列表
func (view *SqliteView) Group(field string, args ...Any) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.parsing(args...)
	if err != nil {
		return []Map{},err
...
//查询唯一对象
func (view *SqliteView) Entity(id Any) (Map,error) {
