...
//批量删除
func (model *MysqlModel) Delete(args ...Map) (int64,error) {
...
//批量更新
func (model *MysqlModel) Update(sets Map, args ...Map) (int64,error) {
...
//统计数量
func (model *MysqlModel) Count(args ...Map) (int64,error) {
...
//查询单条
func (model *MysqlModel) Single(args ...Map) (Map,error) {
...
//查询列表
func (model *MysqlModel) Query(args ...Map) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := model.base.building(args...)
	if err != nil {
		return nil,err
...
//分页查询
func (model *MysqlModel) Limit(offset,limit Any, args ...Map) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := model.base.building(args...)
	if err != nil {
		return nil,err
...
//查询列表
func (model *MysqlModel) Group(field string, args ...Map) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := model.base.building(args...)
	if err != nil {
		return nil,err
