...
//统计数量
func (view *MysqlView) Count(args ...Any) (int64,error) {
...
//查询单条
func (view *MysqlView) Single(args ...Any) (Map,error) {
...
//查询列表
func (view *MysqlView) Query(args ...Any)  ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.parsing(args...)
	if err != nil {
		return []Map{},err
...
//分页查询
func (view *MysqlView) Limit(offset,limit Any, args ...Any) (int64,[]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.parsing(args...)
	if err != nil {
...
//查询列表
func (view *MysqlView) Group(field string, args ...Any) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.parsing(args...)
	if err != nil {
		return []Map{},err
