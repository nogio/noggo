...
//统计数量
func (view *MysqlView) Count(args ...Map) (int64,error) {
...
//查询单条
func (view *MysqlView) Single(args ...Map) (Map,error) {
...
//查询列表
func (view *MysqlView) Query(args ...Map) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.building(args...)
	if err != nil {
		return nil,err
...
//分页查询
func (view *MysqlView) Limit(offset,limit Any, args ...Map) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.building(args...)
	if err != nil {
		return nil,err
...
//查询列表
func (view *MysqlView) Group(field string, args ...Map) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.building(args...)
	if err != nil {
		return nil,err
