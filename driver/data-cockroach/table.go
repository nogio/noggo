...
//创建对象
func (table *CockroachTable) Create(data Map) (Map,error) {
...
//修改对象
func (table *CockroachTable) Change(item Map, data Map) (Map,error) {
...
//删除对象
func (table *CockroachTable) Remove(item Map) (error) {
...
//恢复对象
func (table *CockroachTable) Recover(item Map) (error) {
...
//批量删除，这可是真删
func (table *CockroachTable) Delete(args ...Any) (int64,error) {
...
func (table *CockroachTable) Update(sets Map, args ...Any) (int64,error) {
