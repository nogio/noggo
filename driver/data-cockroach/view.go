...
//统计数量
func (view *CockroachView) Count(args ...Any) (int64,error) {
...
//查询单条
func (view *CockroachView) Single(args ...Any) (Map,error) {
...
//查询列表
func (view *CockroachView) Query(args ...Any) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.parsing(1,args...)
	if err != nil {
		return []Map{},err
...
//分页查询
func (view *CockroachView) Limit(offset,limit Any, args ...Any) (int64,[]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.parsing(1,args...)
	if err != nil {
...
//查询列表
func (view *CockroachView) Group(field string, args ...Any) ([]Map,error) {
	//生成查询条件
	where,builds,orderby,err := view.base.parsing(1,args...)
	if err != nil {
		return []Map{},err
...
//查询唯一对象
func (view *CockroachView) Entity(id Any) (Map,error) {
