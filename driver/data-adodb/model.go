...
//恢复对象
func (model *AdodbModel) Recover(item Map) (error) {
...
//批量删除
func (model *AdodbModel) Delete(args ...Any) (int64,error) {
...
//批量更新
func (model *AdodbModel) Update(sets Map, args ...Any) (int64,error) {
