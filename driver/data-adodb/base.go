...
//获取模型对象
func (base *AdodbBase) Model(name string) (noggo.DataModel) {
...
//是否开启缓存
func (base *AdodbBase) Cache(use bool) (noggo.DataBase) {
	base.caching = use
	return base
}
...
//开启手动模式
func (base *AdodbBase) Begin() (noggo.DataBase) {
	base.manual = true
	return base
}
...
//注意，此方法为实际开始事务
func (base *AdodbBase) begin() (*sql.Tx,error) {
...
//提交事务
func (base *AdodbBase) Submit() (error) {
...
//取消事务
func (base *AdodbBase) Cancel() (error) {
...
//json可能要转成字串才支持
func (base *AdodbBase) packing(value Map) (Map) {
