...
[![GoDoc](https://godoc.org/github.com/nogio/noggo/depend/go-ole?status.svg)](https://godoc.org/github.com/nogio/noggo/depend/go-ole)
...
```
go get github.com/nogio/noggo/depend/go-ole
cd /path/to/go-ole/
go test
